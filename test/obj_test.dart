...
void main() {
 test('Testar operações de Turma, Histórico e Aluno', () {
   ...
   historico1.notas[aluno1]!.add(8.0);
   historico1.notas[aluno1]!.add(7.0);
   historico1.notas[aluno1]!.add(9.0);

   expect(historico1.media(aluno1), (8.0+7.0+9.0)/3);
